...
def atualizar_dino(velocidade_cacto):
    ...
    if y < 300:
        movimento_y += min(1.5, 0.75 + (velocidade_cacto - 5) * 0.06)
        #movimento_y += min(3.0, 0.75 + 0.01 * (velocidade_cacto - 5) ** 2)
